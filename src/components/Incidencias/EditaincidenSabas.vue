...
<template>
  ...
  <div class="container-fluid ancho">
    <div>
      <h3 class="titulo">Formulario de <span class="texto-azul">edición</span> de incidencias</h3>
    </div>
    <div class="row mt-3">
      <div class="col">
        <div class="row">
        ...
        <div class="row">
          <div class="col-12 col-md-4 mb-3">
            ...
            <Calendar name="fechaInicio" v-model="incidencia.fechaInicio" dateFormat="dd/MM/yy"
              @change="calcularDiferenciaDias" required />
          </div>
          <div class="col-12 col-md-4 mb-3">
            <p class="margeninput">Fecha fin de la incidencia</p>
            <Calendar name="fechaFin" v-model="incidencia.fechaFin" dateFormat="dd/MM/yy"
                            ...
                            <div class="col-12 mb-3">
                              <div class="form-check form-check-inline">
                                <input type="checkbox" name="incumplimientos" class="form-check-input" id="check-8"
                                  v-model="incidencia.incumplimiento" value="LLG01O7. Limpieza en general de talleres" />
        ...
        <router-link class="btn btn-info" to="/GestionarInciSabas"
          :class="{ 'text-warning': $route.name === 'GestionarInciSabas' }">Volver</router-link>
