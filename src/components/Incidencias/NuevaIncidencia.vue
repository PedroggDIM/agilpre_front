        ...
        <div class="col">
          ...
          <div class="row">
            <div class="col-12 col-md-4 mb-3">
              ...
              <input type="date" name="fechaInicio" v-model="incidencia.fechaInicio" @change="calcularDiferenciaDias"
                required />
            </div>
            <div class="col-12 col-md-4 mb-3">
          ...
          <div class="row">
            <div class="col-12 col-md-4 mb-3">
              ...
              <select name="estado" class="form-select" v-model="incidencia.estado" required>
                ...
                <option value="Pendiente de tratar en la reunión mensual"
                  v-if="incidencia.unidad === 'Servicio de Abastecimiento'">Pendiente de tratar en la reunión mensual
                </option>
                <option value="En trámite" v-if="incidencia.unidad === 'Servicio de Abastecimiento'">En trámite</option>
                <option value="Cerrada" v-if="incidencia.unidad === 'Servicio de Abastecimiento'">Cerrada</option>
              </select>
            </div>
            <div class="col-12 col-md-4 mb-3">
